...
async function createOAuth1Header(method: string, url: string, params: Record<string, string>) {
  const oauth = {
    oauth_consumer_key: 'BEQYrDaRKkmEx6h9sbzBVwlb2',
    oauth_nonce: crypto.randomUUID().replace(/-/g, ""),
    oauth_signature_method: "HMAC-SHA1",
    oauth_timestamp: Math.floor(Date.now() / 1000).toString(),
    oauth_token: '1919190475405193216-O24qy3qf60bqxr1cp4EqfIRADqWue4',
    oauth_version: "1.0",
  };
  ...
  const signingKey = `${percentEncode('pXAQCAGWFUBS8DSbXmG00ZC4qtwk6qAQn1ob6SrQ9ecchoOTxO')}&${percentEncode('Y3uwVLcWK6Exzvoq5qP0xTBwoBrktpepiB1XsjXCnF4JA')}`;
